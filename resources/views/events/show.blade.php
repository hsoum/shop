...
<div class="container-fluid px-5 mt-2" id="app">
    <div class="d-flex row event-container ">
        <div class="col-md-4 px-0" style="overflow: hidden">
            <div class="image-container" style="background-image: url('{{ asset('storage/photos/'.$event->image) }}')">
            </div>
        </div>
        <div class="col-md-8 pt-4 pl-4">
            ...
            <h5 class="my-5">
                ...
                <a href="{{ route('uploads.create', compact('event')) }}" class="btn btn-link text-right">Add
                    pictures</a>
                @endif
                @endauth
            </h5>
            ...
            <comments-component @auth user-id="{{ Auth::user()->id }}" user-role="{{ Auth::user()->role }}" @endauth
