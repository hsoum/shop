    ...
    <div class="card-deck">
        ...
        <div class="col-md-4">
            <div class="card mb-4 product-card" style="flex-basis: auto">
                <img src="{{ asset('storage/products/'.$product->photo) }}" alt="" class="card-img-top mx-auto"
                    style="height: 250px; width: fit-content; max-width: 100%">
                <div class="card-body">
                    <h4 class="card-title">
                ...
                <div class="card-footer text-center mt-4">
                    ...
                    @endauth
                    @auth
                    @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('It'))
                    <div class="btn-group">
