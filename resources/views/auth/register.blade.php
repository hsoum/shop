                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm"
                                class="col-md-4 col-form-label text-md-right">{{ __('Password (again)') }}</label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="legal-mentions"
                                        id="legal-mentions">

                                    <label class="form-check-label" for="legal-mentions">
                                        {{ __('I accept') }} <a href="https://www.cesi.fr/mentions-legales/"
